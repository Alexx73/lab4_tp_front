  ...
  return (
        ...
        <div id="detailed-pricing" class="w-full overflow-x-auto ">
            <div class="overflow-hidden min-w-max">
                ...
                <div class="grid grid-cols-5 px-4 py-5 text-lg text-gray-700 border-b border-gray-200 gap-x-16 dark:border-gray-700">
                    <div class="text-gray-500 dark:text-gray-400">10 - 11 
                    {/* (<a href="#" class="text-blue-600 hover:underline">view all</a>) */}
                    </div>
                    <div class="cursor-pointer" onClick={() => alert("hey")} >
                    ...
                    <div>
                        <svg class="w-4 h-4 text-red-500 text-lg pt-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                ...
                <div class="grid grid-cols-5 px-4 py-5 text-lg text-gray-700 border-b border-gray-200 gap-x-16 dark:border-gray-700">
                    <div class="text-gray-500 dark:text-gray-400">11 - 12
                    {/* (<a href="#" class="text-blue-600 hover:underline">view all</a>) */}
                    </div>
                    <div>
                        <svg class="w-5 h-5 text-green-500 text-lg " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                ...
                <div class="grid grid-cols-5 px-4 py-5 text-lg text-gray-700 border-b border-gray-200 gap-x-16 dark:border-gray-700">
                    <div class="text-gray-500 dark:text-gray-400">12 - 13
                    {/* (<a href="#" class="text-blue-600 hover:underline">view all</a>) */}
                    </div>
                    <div>
                        <svg class="w-5 h-5 text-green-500 text-lg " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                ...
                <div class="grid grid-cols-5 px-4 py-5 text-lg text-gray-700 border-b border-gray-200 gap-x-16 dark:border-gray-700">
                    <div class="text-gray-500 dark:text-gray-400">13 - 14
                    {/* (<a href="#" class="text-blue-600 hover:underline">view all</a>) */}
                    </div>
                    <div>
                        <svg class="w-5 h-5 text-green-500 text-lg " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
